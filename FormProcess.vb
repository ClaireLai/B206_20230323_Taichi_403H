...
#End Region
    ...
    Private Sub Process_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If SystemParameters.BarcodeOnly = "1" And BarCode_Flag Then
            txtRecipeFile.Text = ""
            txtRecipeFile.Focus()
        ...
        If BarCode_Flag = False And TCPIP_Used = False Then
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If BarCode_Flag = False And SanAn_TCPIP_Used_Flag Then
        ...
        Else
            ...
            btnEnter.Visible = True
        End If
        If BarCode_Flag Then '½[°Ê²v BarBode
            'btnEnter.Visible = True
            txtRecipeFile.Visible = True
        Else
            'btnEnter.Visible = False
    ...
    Private Sub btnRunProcess_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRunProcess.Click
        ...
        Else
            ...
            If GetTrue01Boolean(SystemParameters.AutoRecordData) And (SanAn_TCPIP_Used_Flag Or BarCode_Flag) Then
    ...
    ''' ­pºâ¹w©w¦±½u
    ''' </summary>
    ''' <param name="iTotal">¹w©w°õ¦æ®É¶¡</param>
            ...
            For j = 0 To rwstepindex - 1
                With RecipeNum(i).Plate(k)
                    ...
                    If j = 0 Then
                        ...
                        'Debug.Print("¼ö·U®É®É¶¡,²Ä" + k.ToString + "ÀY²Ä" + j.ToString + "¨B=" + RecipeNum(RecipeRunIndex).Plate(j).AddTempTime(j).ToString)
                        'Debug.Print("¥[À£·U®É®É¶¡,²Ä" + k.ToString + "ÀY²Ä" + j.ToString + "¨B=" + RecipeNum(RecipeRunIndex).Plate(j).AddForceTime(j).ToString)
                    Else
                    ...
                    End If
                End With
                'Debug.Print("¼ö·U®É®É¶¡,²Ä" + k.ToString + "ÀY=" + RecipeNum(RecipeRunIndex).Plate(j).AddTempTime(j).ToString)
