                    ...
                    If RunFlag Then
                        ...
                        If SubProcessTimerEnabled = False Then
                            ...
                            If (Val(subPlateRecipe.Temperature(SubProcessStepIndex)) < RecipeTempLowLimit) Then
                                SubProcessTempOK = True
                            End If
                            If Val(RecipeNum(RecipeRunIndex).BondingSync) = 1 Then '·Å«×
                                SubProcessPressureOK = True
                            End If
                            If Val(RecipeNum(RecipeRunIndex).BondingSync) = 2 Then 'À£¤O
                                SubProcessTempOK = True
                            End If
                            If Val(RecipeNum(RecipeRunIndex).PumpingMode) = 0 Then '¤j®ðÀ£¦X
                                SubProcessTempOK = True
                            End If
