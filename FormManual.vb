...
#End Region
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        'MsgBoxLangOK("1.測試時間: 設定極限壓力或洩漏率測試時間。" + vbCrLf + "2.記錄間隔與檔名請看旁邊計時器，檔名一按即可以看到資料。" + vbCrLf + "3.洩漏率測試會先抽到小於基礎壓力再開始測試", "參數說明")
        MsgBoxLangOK("1.測試時間: 設定極限壓力或洩漏率測試時間。" + vbCrLf + "2.記錄間隔與檔名請看旁邊計時器與資料記錄，檔名一按即可以看到資料。" + vbCrLf + "3.洩漏率測試會先抽到小於基礎壓力再開始測試", "參數說明")
    End Sub
End Class