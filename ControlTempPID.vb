Public Class ControlTempPID
    ...
    Public Sub WriteParameter(ByVal sfile As String)
        Dim thread As New System.Threading.Thread(AddressOf WriteParameter_N)
        thread.Start()

    End Sub
    Public Sub WriteParameter_N(ByVal sfile As String)
        FormTextBoxSave.FindTextBox(Me, Me.Name, FormSaveINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPPL", txtTopPL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPIL", txtTopIL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPDL", txtTopDL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPMAXL", txtTopMaxL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPMINL", txtTopMinL.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPPM", txtTopPM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPIM", txtTopIM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPDM", txtTopDM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPMAXM", txtTopMaxM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPMINM", txtTopMinM.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPPH", txtTopPH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPIH", txtTopIH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPDH", txtTopDH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPMAXH", txtTopMaxH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPMINH", txtTopMinH.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPLOWRANGE", txtTopLowRange.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPHIGHRANGE", txtTopHighRange.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPLOWLIMIT", txtTopLowLimitTemp.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_TOPLOWLIMITPOWER", txtTopLowLimitPower.Text, ParameterINIFile)

        '------------------------------------
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTPL", txtBotPL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTIL", txtBotIL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTDL", txtBotDL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTMAXL", txtBotMaxL.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTMINL", txtBotMinL.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTPM", txtBotPM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTIM", txtBotIM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTDM", txtBotDM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTMAXM", txtBotMaxM.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTMINM", txtBotMinM.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTPH", txtBotPH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTIH", txtBotIH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTDH", txtBotDH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTMAXH", txtBotMaxH.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTMINH", txtBotMinH.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTLOWRANGE", txtBotLowRange.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTHIGHRANGE", txtBotHighRange.Text, ParameterINIFile)

        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTLOWLIMIT", txtBotLowLimitTemp.Text, ParameterINIFile)
        WriteProgData(Section, SiteName + Format(SiteNum, "00") + "_BOTLOWLIMITPOWER", txtBotLowLimitPower.Text, ParameterINIFile)
